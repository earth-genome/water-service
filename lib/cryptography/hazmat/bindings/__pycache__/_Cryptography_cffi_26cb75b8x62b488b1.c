...
static struct PyModuleDef _cffi_module_def = {
  ...
  "_Cryptography_cffi_26cb75b8x62b488b1",
  NULL,
  -1,
  _cffi_methods,
  NULL, NULL, NULL, NULL
...
PyMODINIT_FUNC
PyInit__Cryptography_cffi_26cb75b8x62b488b1(void)
{
  PyObject *lib;
...
PyMODINIT_FUNC
init_Cryptography_cffi_26cb75b8x62b488b1(void)
{
  PyObject *lib;
  lib = Py_InitModule("_Cryptography_cffi_26cb75b8x62b488b1", _cffi_methods);
  if (lib == NULL)
    return;
  if (0 < 0 || _cffi_init() < 0)
    return;
